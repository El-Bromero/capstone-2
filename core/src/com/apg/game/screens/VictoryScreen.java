...
public class VictoryScreen implements Screen {
    ...
    public VictoryScreen(Game game) {
        ...
        Label victoryLabel = new Label("VICTORY!", font);
        table.add(victoryLabel).expandX();
        table.row();
        ...
        Label playAgainLabel = new Label("Click Anywhere to Play Again", fontPlay);
        table.add(playAgainLabel).expandX().padTop(20f);
        table.row();
        Label escapeLabel = new Label("Hit ESC to Exit", fontEsc);
